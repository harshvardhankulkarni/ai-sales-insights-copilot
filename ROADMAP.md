...
| Extras | Done | BENCHMARK.md with expected answers. Failover chain (app/llm.py) 3 slots + canned, 28 pytest pass. WALKTHROUGH.md. README voice notes. Live on Streamlit Cloud. |